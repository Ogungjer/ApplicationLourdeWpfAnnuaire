            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        // Mettez à jour la collection SiteList avec les données chargées
        ...
        private async Task AddSite()
        {
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        // Si l'ajout à l'API est réussi, ajoutez également le site à la collection
                ...
                // Effacez le champ de saisie après l'ajout
                NewSiteVille = "";
            }
            catch (Exception ex)
            {
